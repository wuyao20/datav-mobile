<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="50以上充值" align="center" width="70">
        <template slot-scope="scope">
          {{ scope.row.fiftyMore }}
        </template>
      </el-table-column>
      <el-table-column label="100以上充值" align="center" width="70">
        <template slot-scope="scope">
    ...
    <div id="thatDayChart" style="width: 100%; height: 400px; margin-top: 50px; margin-bottom: 20px;" />
  </div>
</template>
